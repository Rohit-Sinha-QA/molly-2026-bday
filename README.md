...
- **Chapters**: apology letter → photo memory lane → memory-match game → cipher decoder → reasons I love you flip cards → make-a-wish candle → final letter + "Please forgive me" button with confetti.
